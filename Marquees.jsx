...
function Marquees() {
  ...
  return (
    <div className="font-sans py-16 w-full relative overflow-hidden">
      {images.map((elem, index) => (
        <Maqree key={index} direction={index === 0 ? "left" : "right"} imagesurl={elem.map((item) => item.URL)} />
      ))}
    </div>
  );
}
